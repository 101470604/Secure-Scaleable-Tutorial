...
//        return (salary > 0.0);
    ...
    public String setYourDetailsForChange() {
        // check empId is null
    ...
    public String changeYourPassword() {
        // check empId is null
        if (isNull(empId) || isNull(password)) {
            return "debug";
        }
    ...
    public String displayYourAccount() {
        // check empId is null
        if (isNull(empId) || isNull(password) || conversation == null) {
            return "debug";
        }
